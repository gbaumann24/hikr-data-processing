...
| Feld | Typ / Werte | Beschreibung |
| --- | --- | --- |
| `gelaende_und_gefahren.charakter.routenart` | `string[]` | Routencharakter, z. B. Grat, Platte, Wand, Verschneidung, Ueberhang. |
...
| `gelaende_und_gefahren.charakter.felsart` | `string, null` | Felsart, z. B. Granit, Kalk, Gneis. |
...
| `klettern.charakter.kletterstil` | `string[]` | Kletterstil, z. B. kraeftig, technisch, fusslastig, fingerlastig, plattig, athletisch. |
